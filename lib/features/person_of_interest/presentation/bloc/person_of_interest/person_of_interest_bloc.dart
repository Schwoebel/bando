...
class PersonOfInterestBloc
  ...
  final PersonOfInterestManager managePersonOfInterest;

  PersonOfInterestBloc({@required this.managePersonOfInterest})
      : assert(managePersonOfInterest != null), super(InitialPersonOfInterestState());
  ...
  Stream<PersonOfInterestState> mapEventToState(
    ...
    if (event is ReadPersonOfInterestEvent) {
      ...
      final Either<Failure, List<PersonOfInterest>> result = await managePersonOfInterest.readAll();
