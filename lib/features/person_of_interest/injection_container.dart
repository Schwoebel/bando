...
import 'package:bando/features/person_of_interest/data/repositories/person_of_interest_repository_impl.dart';
import 'package:bando/features/person_of_interest/domain/repositories/person_of_interest_repository.dart';
import 'package:bando/features/person_of_interest/domain/use_cases/manage_person_of_interest.dart';
import 'package:bando/features/person_of_interest/presentation/bloc/person_of_interest/person_of_interest_bloc.dart';
...
void init() async {
  ...
  sl.registerLazySingleton<PersonOfInterestManager>(
    () => PersonOfInterestManager(
